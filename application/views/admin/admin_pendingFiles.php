...
<div class="content-wrapper">
                ...
                <div class="card cmsBoxCard">
                    <ul class="nav nav-tabs" role="tablist">
                      <li role="tab" class="active"><a href="#home" aria-controls="home" role="tab"
                            ...
                            <li role="tab"><a href="#fileNotReading" aria-controls="fileNotReading" role="tab" data-toggle="tab"><i
                                    class="fa fa-file-excel-o" aria-hidden="true"></i> <span>Not Reading Files</span></a></li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="profile">
                            ...
                            <div class="tab-pane" id="fileNotReading">
                            <div class="" style="width:100%;">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="box" style="margin-top:0px!important; border: none!important;">
                                                <div class="box-header" style="padding:0px!important;">
                                                    <h4 style="margin-left:10px;" class="text-bold">Not Reading Files </h4>
                                                </div>
                                                <div class="box-body">
                                                    <table id="example2" class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr id="example">
                                                                ...
                                                                <th>File Execution Status</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody id="displayNotReadFilesTable">

                                                            <tr style="display: none;" id="displayNodataFiles">
                                                                <td colspan="12">No data found</td>
                                                            </tr>
  ...
  <script id="displayfilenotReadingAdmin" type="text/template">
        {{#data}}
      <tr>
        <td>{{fileName}}</td>
        <td>{{fileType}}</td>
        <td>{{transactionStatus}}</td>
        <td>{{fileExecutionStatus}}</td>
      </tr>
      {{/data}}
      </script>
