...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        || $basePATH_URL == "admin/whatsappNotification"    || $basePATH_URL == "admin/pendingFiles" || $basePATH_URL == "admin/getGroupofLender"|| $basePATH_URL == "admin/lenderparticipateddeal" || $basePATH_URL == "admin/paytmTransactions"|| $basePATH_URL == "admin/salariedDeals" || $basePATH_URL == "admin/selfEmployedDeals"|| $basePATH_URL == "admin/testDeals"|| $basePATH_URL == "admin/offlineInterest"|| $basePATH_URL == "admin/dealNotifications"  || $basePATH_URL == "admin/viewDealTypePayOut" || $basePATH_URL == "admin/futureDeals" || $basePATH_URL == "admin/monthlyDealSummary"||   $basePATH_URL == "admin/dealSearchInformation"  ){?>active menu-open<?php } ?>">
                <a href="#">
                ...
                <ul class="treeview-menu">
                    ...
                    <li <?php if ($basePATH_URL == "admin/dealSearchInformation"){?> class="hi-tree-menu" <?php }?>>
                        <a href="dealSearchInformation"><i class="fa fa-dot-circle-o"></i>View Deal Info</a>
                    </li>
          ...
          <?php if ($basePATH_URL == "admin/lendersapplications" || $basePATH_URL == "admin/lenderWallettransactions" || $basePATH_URL == "admin/uploadtransactions"|| $basePATH_URL == "admin/lenderreferalinfo"|| $basePATH_URL == "admin/approveReferenceamount" || $basePATH_URL == "admin/editReferenceDeatils" || $basePATH_URL == "admin/editGroupinfo"|| $basePATH_URL == "admin/sumofDealAmountInfo"|| $basePATH_URL == "admin/lenderstatistics"|| $basePATH_URL == "admin/registerLenderUsers"|| $basePATH_URL == "admin/monthlyReferalEarning" || $basePATH_URL == "admin/activeLenderParticipationAmount" ){?>active menu-open<?php } ?>">
                ...
                <ul class="treeview-menu displaySuperAdmin">
                    <li <?php if ($basePATH_URL == "admin/lendersapplications"){?> class="active" <?php } ?>><a
                        ...
                        <li <?php if ($basePATH_URL == "admin/activeLenderParticipationAmount"){?> class="active" <?php } ?>><a
                            href="activeLenderParticipationAmount"><i
