                    ...
                    <form>
                        ...
                        <div class="form-group row">
                            <textarea type="text" name="" class="form-control queryComments" placeholder="Enter The Comments"></textarea>
                              <span class="error commentsErrorMessage" style="display:none;">Enter The comments</span>
                        </div>
                        ...
                        <div class="form-group row uploadAttachment">
                            ...
                            <div class="upload_pdf col-md-4 pull-right">
                                <input class="custom-file-input queryImageUpload query-file-upload-image pull-left" id="query"
                ...
                <div class="modal-footer">
                    <div align="right">
                        <button type="button" class="btn  btn-primary btn-sm approveQueryCommentsBtn"
                           data-clikedId="" data-userId="" data-status=""
